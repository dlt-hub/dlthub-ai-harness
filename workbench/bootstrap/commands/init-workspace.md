...
> **This is the right path for an existing project** — i.e. when the user already has a `pyproject.toml`/venv. It sets dlthub up **in place** and the agent can drive it end to end.
>
